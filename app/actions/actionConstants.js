...
export const SET_COLLECTIONS_ASYNC = 'SET_COLLECTIONS_ASYNC';
export const SET_LOADING = 'SET_LOADING';
export const SET_TOTAL = 'SET_TOTAL';
export const INSTALL_COLLECTION = 'INSTALL_COLLECTION';
export const INSTALL_COLLECTION_ASYNC = 'INSTALL_COLLECTION_ASYNC';
export const UNINSTALL_COLLECTION = 'UNINSTALL_COLLECTION';
export const UNINSTALL_COLLECTION_ASYNC = 'UNINSTALL_COLLECTION_ASYNC';
